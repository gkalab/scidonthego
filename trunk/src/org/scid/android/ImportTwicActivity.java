...
public class ImportTwicActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.progressDlg = ProgressDialog.show(this, "Getting information from TWIC",
	...
	protected void showList() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int pos,
				...
				progressDlg = ProgressDialog.show(ImportTwicActivity.this, "Downloading from TWIC",
						"Downloading...", true, false);
				AsyncTask task = new ImportTwicTask().execute(ImportTwicActivity.this, progressDlg, item.getLink());
			}
		});
